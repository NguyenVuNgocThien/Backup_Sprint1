                ...
                <div className="col-sm-12 col-xl-9">
                    <form onSubmit={handleSubmit(onSubmit)} className='create-user-form mx-3 mt-4'>
                        <div className="row" style={{ marginBottom: '18px' }}>
                            <label htmlFor="firstName" className="col-sm-3 pe-0 ps-1 col-form-label">First Name</label>
                            <div className="col-sm-9 ps-0">
                                <input
                                    type="text"
                        ...
                        <div className="row" style={{ marginBottom: '18px' }}>
                            <label htmlFor="lastName" className="col-sm-3 pe-0 ps-1 col-form-label">Last Name</label>
                            <div className="col-sm-9 ps-0">
                                <input
                                    type="text"
                                    className="form-control"
                        ...
                        <div className="row" style={{ marginBottom: '18px' }}>
                            <label htmlFor="dateOfBirth" className="col-sm-3 pe-0 ps-1 col-form-label">Date of Birth</label>
                            <div className="col-sm-9 ps-0">
                                <Controller
                                    control={control}
                                    name="dateOfBirth"
                                    render={({
                                        ...
                                        >
                                            ...
                                            />
                                            <label htmlFor="dateOfBirth" className="position-absolute" style={{ right: '3%', top: '0' }}>
                        ...
                        <div className="row" style={{ marginBottom: '18px' }}>
                            <label htmlFor="gender" className="col-sm-3 pe-0 ps-1 col-form-label">Gender</label>
                        ...
                        <div className="row" style={{ marginBottom: '18px' }}>
                            <label htmlFor="joinedDate" className="col-sm-3 pe-0 ps-1 col-form-label">Joined Date</label>
                            <div className="col-sm-9 ps-0">
                                <Controller
                                    control={control}
                                    name="joinedDate"
                                    render={({
                                        ...
                                        >
                                            <DatePicker
                                                ...
                                                style={{ height: "100%" }}
                                            />
                                            <label htmlFor="joinedDate" className="position-absolute" style={{ right: '3%', top: '0' }}>
                                                <i className="bi bi-calendar-date-fill" style={{ fontSize: "23px", color: '#707070' }}></i>
                                            </label>
                                        </div>
                                    )}
                        ...
                        <div className="row" style={{ marginBottom: '18px' }}>
                            <label htmlFor="userType" className="col-sm-3 pe-0 ps-1 col-form-label">Type</label>
                            <div className="col-sm-9 ps-0">
