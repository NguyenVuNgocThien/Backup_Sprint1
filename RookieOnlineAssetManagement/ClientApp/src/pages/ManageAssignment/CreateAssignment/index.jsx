        ...
        <div>
            ...
            <div className="row">
                <div className="col-sm-12 col-xl-9">
                    <form onSubmit={handleSubmit(onSubmit)} className='create-assigment-form mx-3 mt-4'>
                        <div className="row" style={{ marginBottom: '18px' }}>
                            <label htmlFor="user" className="col-sm-3 pe-0 ps-1 col-form-label">User</label>
                            <div className="col-sm-9 ps-0 position-relative">
                                ...
                                <label htmlFor="user" className="position-absolute" style={{ right: '4%', top: '0' }}>
                                    <i className="bi bi-search" style={{ fontSize: "20px", color: '#000' }}></i>
                                </label>
                                {
                                    isSelectingUser &&
                                    <SelectTable
                        ...
                        <div className="row" style={{ marginBottom: '18px' }}>
                            <label htmlFor="asset" className="col-sm-3 pe-0 ps-1 col-form-label">Asset</label>
                            <div className="col-sm-9 ps-0 position-relative">
                                <input
                                    type="text"
                                    className="form-control"
                                ...
                                ></input>
                                <label htmlFor="asset" className="position-absolute" style={{ right: '4%', top: '0' }}>
                                    <i className="bi bi-search" style={{ fontSize: "20px", color: '#000' }}></i>
                                </label>
                        ...
                        <div className="row" style={{ marginBottom: '18px' }}>
                            <label htmlFor="assignedDate" className="col-sm-3 pe-0 ps-1 col-form-label">Assigned Date</label>
                            <div className="col-sm-9 ps-0">
                                <Controller
                                    control={control}
                                    name="assignedDate"
                                    render={({ field }) => (
                                        ...
                                        >
                                            ...
                                            />
                                            <label htmlFor="assignedDate" className="position-absolute" style={{ right: '3%', top: '0' }}>
                        ...
                        <div className="row" style={{ marginBottom: '18px' }}>
                            <label htmlFor="note" className="col-sm-3 pe-0 ps-1 col-form-label">Note</label>
                            <div className="col-sm-9 ps-0">
                                <textarea className="form-control" id="note" rows="2"
                                    {...register("note",
                                        {
                                            required: "Asset is required",
                                            onBlur: (e) => trigger('note')
                                        })}>
                                </textarea>
                            </div>
                        </div>
                        <ShowErrorMessage name="note" />
